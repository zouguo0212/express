...
Ext.define('register.RegisterModel', {
...
var registerGrid = new Ext.grid.GridPanel({
    id : 'registerGrid',
    plugins : [rowEditing],
    store : store,
    region : 'center',
...
registerGrid.getSelectionModel().on('selectionchange',
    function(selModel, selections) {
        registerGrid.down('#delete').setDisabled(selections.length === 0);
    });
...
Ext.application({
    ...
    launch : function() {
        Ext.create('Ext.container.Viewport', {
            layout : 'border',
            items : [registerForm, registerGrid]
        });
    }
});
